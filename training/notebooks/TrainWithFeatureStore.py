...
# ``dne_databricks_ai/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-dne_databricks_ai-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.dne_databricks_ai.dne_databricks_ai-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.dne_databricks_ai.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.dne_databricks_ai.trip_dropoff_features",
