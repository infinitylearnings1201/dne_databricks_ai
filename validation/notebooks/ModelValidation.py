...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``dne_databricks_ai/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in dne_databricks_ai/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in dne_databricks_ai/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-dne_databricks_ai-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.dne_databricks_ai.dne_databricks_ai-model", "Full (Three-Level) Model Name")
